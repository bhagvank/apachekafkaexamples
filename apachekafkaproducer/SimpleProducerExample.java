...
public class SimpleProducerExample {
   ...
   public static void main(String[] args) throws Exception{
      ...
      for(int i = 0; i < 10; i++)
      {
         //producer.send(new ProducerRecord<String, String>(exampleTopicName, 
         //   Integer.toString(i), Integer.toString(i)));
       
  //      if(i%2 == 0)
   //     { 
    //     producer.send(new ProducerRecord<String, String>(exampleTopicName,"kafka and storm "+Integer.toString(i))); 
   //     } else { 
     //     producer.send(new ProducerRecord<String, String>(exampleTopicName,"hi this is a test "+Integer.toString(i))); 
    //    }
